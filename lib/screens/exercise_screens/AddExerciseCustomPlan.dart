...
class AddExerciseCustomPlan extends StatefulWidget {
  const AddExerciseCustomPlan({Key? key}) : super(key: key);

  @override
  _AddExerciseCustomPlanState createState() => _AddExerciseCustomPlanState();
}

class _AddExerciseCustomPlanState extends State<AddExerciseCustomPlan>
        ...
        body: Container(
          child: ListView(
            ...
            children: [
              ...
              gridSectionforAddFood(
                  "assets/images/meditation_1.png", "Running", "10 min", "200"),
              Padding(
              ...
              Padding(
                ...
                child: DDText(title: "Add Set", color: const Color(0xff4885ED)),
              ),
              SizedBox(
