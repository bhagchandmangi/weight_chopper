            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    detailFood(context,
                        icon: "assets/icons/fruit.svg", title: "Food Name"),
                  ],
                ),
              ),
              SizedBox(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    detailFood(context,
                        icon: "assets/icons/brand.svg", title: "Brand Name"),
                  ],
                ),
              ),
              SizedBox(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    detailFood(context,
                        icon: "assets/icons/calories.svg", title: "Calories"),
                  ],
                ),
              ),
              SizedBox(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          detailFood(context,
                              icon: "assets/icons/fat.svg", title: "Fat (g)"),
                        ],
                      ),
                    ),
                  ),
                  Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          detailFood(context,
                              icon: "assets/icons/saturated-fat.svg",
                              title: "Saturated Fat"),
                        ],
                      ),
                    ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          detailFood(context,
                              icon: "assets/icons/carbohydrates.svg",
                              title: "Carbohydrates"),
                        ],
                      ),
                    ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          detailFood(context,
                              icon: "assets/icons/sugar-cube.svg",
                              title: "Sugars (g)"),
                        ],
                      ),
                    ),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          detailFood(context,
                              icon: "assets/icons/cholestrol.svg",
