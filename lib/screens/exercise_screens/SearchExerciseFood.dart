...
import 'package:weightchopper_flutter_project/screens/diet_plan_screens/tabs/AddDietFood.dart';
...
class SearchExerciseFood extends StatefulWidget {
  @override
  _SearchExerciseFoodState createState() => _SearchExerciseFoodState();
}

class _SearchExerciseFoodState extends State<SearchExerciseFood> {
                          ...
                          Expanded(
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                    MaterialPageRoute(builder: (context) {
                                  return const AddExerciseCustomPlan();
                                }));
                              },
                              child: Column(
