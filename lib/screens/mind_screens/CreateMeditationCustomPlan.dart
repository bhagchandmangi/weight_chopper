...
import 'package:weightchopper_flutter_project/screens/mind_screens/SelectMeditationPlan.dart';
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const SelectMeditationPlan()));
            },
            child: Row(
              children: [
                imageUrl == null
