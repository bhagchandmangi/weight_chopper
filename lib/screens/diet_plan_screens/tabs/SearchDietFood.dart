...
class SearchDietFood extends StatefulWidget {
  @override
  _SearchDietFoodState createState() => _SearchDietFoodState();
}

class _SearchDietFoodState extends State<SearchDietFood> {
