...
class AddMeditationCustomPlan extends StatefulWidget {
  const AddMeditationCustomPlan({Key? key}) : super(key: key);

  @override
  _AddMeditationCustomPlanState createState() =>
      _AddMeditationCustomPlanState();
}

class _AddMeditationCustomPlanState extends State<AddMeditationCustomPlan>
        ...
        body: Container(
          child: ListView(
            ...
            children: [
              ...
              leftRightheading(left: "Morning", right: "Select Time"),
              SizedBox(height: MySize.size10),
              gridSectionforAddFood("assets/images/meditation_1.png",
                  "Stretching", "5 - 8 min", "200"),
              Padding(
                padding: EdgeInsets.symmetric(horizontal: MySize.size42!),
                child: const Divider(),
              ),
              // leftRightheading(left: "Lunch", right: "Select Time"),
              // SizedBox(height: MySize.size10),
